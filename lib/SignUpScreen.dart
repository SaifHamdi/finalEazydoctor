      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: [
            Image.asset('assets/images/x1.0/register.jpg',width: 175,height: 190,),
            SizedBox(height: 30,),
            reusableTextField('Enter UserName', Icons.person_outline_outlined, false, userTextController),
            SizedBox(height: 30,),
